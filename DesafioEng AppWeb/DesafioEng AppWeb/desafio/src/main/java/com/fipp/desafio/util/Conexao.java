...
public class Conexao {
    ...
    public boolean conectar(String driver, String local, String banco, String usuario, String senha) {
        try {
    ...
    public boolean desconectar() {
        try {
            ...
            erro = "Não foi possível desconectar" + e;
        }
        return false;
    }
